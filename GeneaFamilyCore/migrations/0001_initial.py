# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-06 05:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, verbose_name='Date du baptême')),
                ('time', models.TimeField(blank=True, verbose_name='Heure du baptême')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(blank=True, verbose_name='Heure de décès')),
                ('date_is_approximately', models.BooleanField(default=False, help_text='Cochez cette case si la date est approximative.', verbose_name='Environ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.FloatField(blank=True, verbose_name='Taille')),
                ('rectified_size', models.FloatField(blank=True, verbose_name='Taille')),
                ...
                ('recruitment_matricul_number', models.IntegerField(blank=True, verbose_name='Numéro matricule du recrutement')),
                ('mobilisation_class', models.IntegerField(blank=True, verbose_name='Classe de mobilisation')),
                ('recruitment_draw', models.IntegerField(blank=True, verbose_name='Numéro de tirage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(blank=True, verbose_name="Date de l'union")),
                ...
                ('end_date', models.DateField(blank=True, verbose_name="Date de fin de l'union")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('member_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GeneaFamilyCore.Member')),
                ('wedding_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GeneaFamilyCore.Union')),
            ],
        ),
        migrations.CreateModel(
            name='UnionWitness',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('for_who', models.CharField(choices=[('F', 'Le marié'), ('M', 'La mariée'), ('U', 'Non spéficié')], help_text='Pour qui ce témoin acte sa présence', max_length=1)),
                ('member_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GeneaFamilyCore.Member')),
                ('wedding_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GeneaFamilyCore.Union')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='family',
            name='union_fk',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GeneaFamilyCore.Union'),
        ),
        migrations.AddField(
            model_name='event',
            name='event_type_fk',
