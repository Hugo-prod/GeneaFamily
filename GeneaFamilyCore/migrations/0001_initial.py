# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-11-06 20:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source_type', models.CharField(choices=[('G', 'Global'), ('N', 'Naissance'), ('D', 'Décès'), ('B', 'Baptême'), ('U', 'Union'), ('M', 'Militaire')], max_length=1, verbose_name='Sourcer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('member_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GeneaFamilyCore.Member', verbose_name='Membre')),
                ('source_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GeneaFamilyCore.Source')),
            ],
        ),
        migrations.CreateModel(
            name='Union',
